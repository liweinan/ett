  ...
  def generate_weekly_workload
    Package.transaction do
      ...
      tasks.each do |task|
        ...
        current_date = Date.parse(params[:from]) unless params[:from].blank?
        ...
        # Find the package that is updated to a "finished status" in current
        # week.
        ...
        # The candidates are the packages that need to be calculated into
        # weekly workload.
        candidates = []

        # The logic to search for candidates.
        packages.each do |package|
          # search for changelog, to see if the package has statuses changed
          # during this week.
