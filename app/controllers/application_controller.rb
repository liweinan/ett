...
#    children = "union select children.id as id from tasks parent join tasks children on parent.id = children.parent_id and parent.name = #{bt_quoted} "
  ...
  def has_ver_integration?(task)
    return has_x_integration?(task, ['ver'])
  end
